 ...
 */
@Configuration
public class SpringOpaqueTokenIntrospectorBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        if(SpringOpaqueTokenIntrospector.class.isAssignableFrom(bean.getClass())) {
            SpringOpaqueTokenIntrospector object = (SpringOpaqueTokenIntrospector)bean;
