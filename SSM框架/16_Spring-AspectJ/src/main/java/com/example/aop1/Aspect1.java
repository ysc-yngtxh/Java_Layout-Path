...
public class Aspect1 {
	...
	/**
	 * 指定通知方法中的参数：JoinPoint <p>
	 * JoinPoint：业务方法，要加入切面功能的业务方法 <p>
	 * 作用：可以再通知方法中获取方法执行时的信息，例如方法名称，方法的实参。<p>
	 * 如果你的切面功能中需要用到方法的信息，就加入JoinPoint。这个JoinPoint参数的值是由框架赋予，必须是第一个位置的参数
	 * <p>
