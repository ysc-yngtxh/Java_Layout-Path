...
public class MyAspect4 {
     ...
     */
    @Pointcut(value="execution(* *..OutServiceImpl.like(..))")
    private void mypt(){
        //无需代码
    }

    @Before(value="execution(* *..OutServiceImpl.like(String,Integer))")//这里使用了JoinPoint jp需要参数类型，故而不使用mypt()
    ...
    public void MyText2(Object res){
        System.out.println("嘚，我们喜欢李晶晶的后置通知，当当当！"+res);
        if("李晶晶，我喜欢你!".equals(res)){
    ...
    public Object MyText3(ProceedingJoinPoint pjp) throws Throwable {
        System.out.println("然后我们再来看一下喜欢李晶晶的环绕通知，在目标方法执行之前:"+ new Date());
