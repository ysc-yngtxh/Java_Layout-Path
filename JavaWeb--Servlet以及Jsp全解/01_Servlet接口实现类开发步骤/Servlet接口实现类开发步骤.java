...
/*
  ...
  三：Servlet接口实现类开发步骤【参考A1Servlet】
         ...
         第二步：重写HttpServlet父类两个方法。doGet或者doPost
                  浏览器---get---->com.bjpowernode.controller.A1Servlet.doGet()
                  浏览器---post--->com.bjpowernode.controller.A1Servlet.doPost()
         第三步：将Servlet接口实现类信息【注册】到Tomcat服务器
                  ...
                  <servlet>
                    ...
                    <servlet-class>com.bjpowernode.controller.A1Servlet</servlet-class>   <%--声明servlet接口-->
                  </servlet>

                  Tomcat String mm = "com.bjpowernode.controller.A1Servlet";
  ...
  四、Servlet对象生命周期【参考B2Servlet】
         ...
         2、在默认的情况下，Http服务器接收到对于当前Servlet接口实现类第一次请求时自动创建这个Servlet接口实现类的实例对象
            ...
            <servlet>
                ...
                <servlet-class>com.bjpowernode.controller.B2Servlet</servlet-class>
