...
public class MessageTest {
	...
	public void sameIdentityAs() {
		...
		Date sendTime = new Date();
		Message message = new Message(messageId, MessageCategory.CHAT, sender, receiver, content, sendTime);
		Assert.assertTrue(message.sameIdentityAs(new Message(messageId, MessageCategory.CHAT, sender, receiver, new Content(MessageCategory.CHAT,
		                                                                                                                    content + "/" + UUID.randomUUID()), sendTime)));
	}
}
