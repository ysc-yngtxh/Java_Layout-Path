...
import com.cn.leyou.repository.GoodsRepository;
import com.cn.leyou.service.SearchService;
...
public class RepositoryTest {
    ...
    public void loadData(){
        ...
        do{
            ...
            List<Spu> spuList = result.getItems();  //获取分页的总页数
            ...
            page++;
            size = spuList.size();
        }while(size == 100); //表示当size==100为true，则停止执行do模块代码
    }
}
