    ...
    public static void main(String[] argv) throws Exception {
        ...
        */
        ...
        DefaultConsumer consumer = new DefaultConsumer(channel) {
            ...
            public void handlerDelivery(String consumerTag, Envelope envelope, BasicProperties basicProperties, byte[] body)throws IOException {
                //body 即消息体
        ...
        /*
          队列中的参数说明：
             ...
             参数3：回调方法,为消息接收者的标签，用于多个消费者同时间听一个队列时用于确认不同消费者
