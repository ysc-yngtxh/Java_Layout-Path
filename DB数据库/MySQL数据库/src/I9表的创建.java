...
---------------------------------------------------------------------------------------------------------------
  2、创建学生表
        ...
        // unsigned关键字：表示的是为“无符号”的意思，即为非负数，用此类型可以增加数据长度：
                          例如 tinyint的范围[-128,127] 最大值是127，tinyint unsigned 最大值就可以到127*2，且unsigned只针对整型。
...
---------------------------------------------------------------------------------------------------------------
  5、批量插入
        ...
        | id | no | name     | sex | class_no   | birth      | time                | update_time        | graduate|
        +----+----+----------+-----+------------+------------+---------------------+--------------------+---------+
        |  6 |  1 | ZhangSan | 1   | 高三1班     | 1950-10-12 | 2023-10-05 04:20:00 | 2023-10-05 04:20:00| 1       |
        |  7 |  2 | lisi     | 1   |            | 1997-04-29 | 2023-10-05 04:30:00 | 2023-10-05 04:30:00| 1       |
        |  8 |  3 | ZhangSan2| 1   | 高三1班     | 1990-10-12 | 2023-10-05 04:40:00 | 2023-10-05 04:40:00| 1       |
        |  9 |  4 | ZhangSan3| 1   | 高三2班     | 1991-10-12 | 2023-10-05 04:50:00 | 2023-10-05 04:50:00| 1       |
        |  10|  5 | ZhangSan4| 0   | 高三3班     | 1992-10-12 | 2023-10-05 05:00:00 | 2023-10-05 05:00:00| 1       |
