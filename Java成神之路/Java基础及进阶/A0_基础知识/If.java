...
public class If{
	public static void main(String[] args) {
		java.util.Scanner a=new java.util.Scanner(System.in);     //接受用户键盘输入——————在DOS中输入命令指令，，只需要输入一条语句就可以了
		...
		//性别：1是男性，0是女性
		if(i==1) {
			System.out.print("请输入温度：");//温度在晴天时才需要进行输入，所以将温度变量放入if语句中。这样在雨天时候就不需要进行输入温度
			int e=a.nextInt();
			if(e>30) {
				if(r==1) {
