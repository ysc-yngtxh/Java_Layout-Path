package L12_反射.反射Ⅰ_获取Class实例化对象;
...
public class 反射2_实例化对象 {
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> c = Class.forName("L12_反射.反射Ⅰ_获取Class实例化对象.实例化对象2.User");  // c代表User类型1
        ...
        try {
            // 创建输入流对象。
            fis = new FileInputStream(System.getProperty("User.dir") + "/Java基础及进阶/L12_反射/反射Ⅰ_获取Class实例化对象/实例化对象2/classinfo.properties");
            // 创建属性类对象Map
