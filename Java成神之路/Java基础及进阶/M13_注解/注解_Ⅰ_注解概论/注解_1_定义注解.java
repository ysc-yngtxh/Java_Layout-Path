package M13_注解.注解_Ⅰ_注解概论;

/*
1、M13_注解，或者叫做注释，英文单词是：Annotation
...
5、JDK内置了那些注解？
     Deprecated：用@Deprecated注释这样的程序元素。不鼓励一个程序员使用，通常是因为它是危险的，因为有更好的选择的存在。
