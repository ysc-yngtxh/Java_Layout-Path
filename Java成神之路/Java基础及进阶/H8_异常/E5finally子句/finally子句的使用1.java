...
关于try..catch中的finally子句：
    ...
    2、finally语句通常使用在哪·些情况下？
       通常在finally语句块中完成资源的释放/关闭
       因为finally中的代码比较有保障
       即使try语句块中的代码有异常，finally中的代码也会正常执行

 */
public class finally子句的使用1 {
    public static void main(String[] args) {

        FileInputStream fis =null;
        try{
            //创建输入流对象
            fis = new FileInputStream("C:\\Program Files\\Java\\jdk1.8.0_131\\bin\\jar.exe");
            //开始读文件。。。
