 ...
 *       abstract class 类名{}
 *
 *  3、抽象类是无法实例化，无法创建对象的，所以抽象类是用来被子类继承的
 *
 *  4、不可以在抽象类中加上关键字final，因为final类不能被继承。
 *
 *  5、抽象类的子类也可以是抽象类
 *
 *  6、抽象类虽然无法实例，但是有构造方法，构造方法是供子类使用的
 *
 *  7、抽象类关联到一个概念：抽象方法
