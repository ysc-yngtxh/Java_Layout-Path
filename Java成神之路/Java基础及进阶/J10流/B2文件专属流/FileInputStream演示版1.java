...
public class FileInputStream演示版1 {
    public static void main(String[] args) {
        ...
        try{
            ...
            // 绝对路径：D:IDEA\java-layout-path\Java成神之路\Java基础及进阶\J10流\Filetemp
            // 相对路径：从IDEA模块路径出发
            fis2 = new FileInputStream(System.getProperty("user.dir") + "/Java基础及进阶/J10流/Filetemp");
            fis3 = new FileInputStream(System.getProperty("user.dir") + "/Java基础及进阶/J10流/Filetemp");
            // 开始读
            while(true){
