 ...
 */
public class YoujiawankuConfigApplicationContext1 {
    ...
    public YoujiawankuConfigApplicationContext1(Class<?> rootClass) {
    ...
    private void scan(Class<?> rootClass) {
        ...
        // TODO 2、扫描路径下的所有类
        // 获取当前类加载器
        ClassLoader classLoader = YoujiawankuConfigApplicationContext1.class.getClassLoader();
