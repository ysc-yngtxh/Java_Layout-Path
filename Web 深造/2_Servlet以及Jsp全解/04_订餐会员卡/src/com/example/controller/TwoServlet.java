            ...
            if("userName".equals(key)) {
                ...
                if("饺子".equals(food)) {
                    if(jiaozi_money > money) {
                        ...
                        newCard = new Cookie("money",Integer.toString(money-jiaozi_money));
                    ...
                    if(miantiao_money > money) {
                        ...
                        newCard = new Cookie("money",Integer.toString(money-miantiao_money));
                    ...
                    if(gaifan_money > money) {
                        ...
                        newCard = new Cookie("money", Integer.toString(money-gaifan_money));
