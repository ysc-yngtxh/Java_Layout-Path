...
/**
 ...
 Tomcat根据Servlet规范调用servlet接口实现类规则：
           1、Tomcat有权创建servlet接口实现类实例对象    Servlet com.example.controller.A1Servlet = new com.example.controller.A1Servlet();
           2、Tomcat根据实例对象调用Service方法处理当前请求   com.example.controller.A1Servlet.service()

           com.example.controller.A1Servlet---------->(abstract)HttpServlet---------->(abstract)GenericServlet------------>servlet接口
