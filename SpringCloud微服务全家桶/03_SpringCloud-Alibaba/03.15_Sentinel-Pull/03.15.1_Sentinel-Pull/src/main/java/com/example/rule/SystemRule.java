...
public class SystemRule {
    ...
    public void readWriteRuleFileFlow(String ruleFilePath) throws IOException {
        ...
        ReadableDataSource<String, List<com.alibaba.csp.sentinel.slots.system.SystemRule>> ds = new FileRefreshableDataSource<>(
                ruleFile, source -> JSON.parseObject(source, new TypeReference<List<com.alibaba.csp.sentinel.slots.system.SystemRule>>() {})
        );
        ...
        WritableDataSource<List<com.alibaba.csp.sentinel.slots.system.SystemRule>> wds = new FileWritableDataSource<>(ruleFile, this::encodeJson);
