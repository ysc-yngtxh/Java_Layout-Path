...
@Slf4j
@SpringBootTest
class FesodReadExcelApplicationTests {
    ...
    void readExcel3() {
        ...
        FesodSheet.read(fileString, ReadDemo2.class, new ReadListener<ReadDemo2>() {
            // 单次缓存的数据量
    ...
    void readExcel4() {
        ...
        try (ExcelReader excelReader = FesodSheet.read(fileName).build()) {
            ...
            ReadSheet readSheet1 =
                    FesodSheet.readSheet(0).head(ReadDemo2.class).registerReadListener(new DemoDataListener<ReadDemo2>()).build();
            ReadSheet readSheet2 =
                    FesodSheet.readSheet(1).head(ReadDemo2.class).registerReadListener(new DemoDataListener<ReadDemo2>()).build();
    ...
    public void extraRead() {
        ...
        FesodSheet.read(fileName, ReadDemo2.class, new DemoDataListener<ReadDemo2>())
                // 需要读取批注 默认不读取
    ...
    public void cellDataRead() {
        ...
        FesodSheet.read(fileName, ReadDemo3.class, new DemoDataListener<ReadDemo3>()).sheet().doRead();
    }
