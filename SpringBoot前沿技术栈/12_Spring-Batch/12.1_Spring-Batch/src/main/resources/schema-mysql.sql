...
-- 可以在Maven依赖路径中找到对应的sql文件
-- spring-batch-core-5.0.2.jar!/org/springframework/batch/core/schema-mysql.sql

-- 这里的删库建库语句不生效的，放着吧也不影响
DROP DATABASE IF EXISTS `technician`;
CREATE DATABASE IF NOT EXISTS `technician` CHARACTER SET UTF8;
USE technician;
