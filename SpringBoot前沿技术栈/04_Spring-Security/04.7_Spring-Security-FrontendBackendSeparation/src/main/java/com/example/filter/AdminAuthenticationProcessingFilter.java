...
public class AdminAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
	...
	protected AdminAuthenticationProcessingFilter(CustomAuthenticationManager customAuthenticationManager,
		...
		// PathPatternRequestMatcher路径匹配器，拦截url为 "/toLogin" 的POST请求作为登录接口
		super(PathPatternRequestMatcher.withDefaults().matcher(HttpMethod.POST, "/toLogin"), customAuthenticationManager);
