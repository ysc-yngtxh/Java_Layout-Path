...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
             ...
             *    Customizer.withDefaults()使用 Spring 安全性提供的默认值启用安全功能。 这是 lambda 表达式的快捷方式。it → {}
             */
             ...
             *    1、自动缩进使配置更具可读性。
             *    2、无需使用.and()
             *    3、Spring Security DSL具有与其他Spring DSL类似的配置风格，例如Spring Integration和Spring Cloud Gateway。
             */
             // 运行请求后会自动跳转到第三方登录界面
