...
3. ### ***设置4个处理器***
   ...
   ![输入图片说明](image/image1-3.png)

---

4. ### ***设置虚拟机内存：8G***

   ![输入图片说明](image/image1-4.png)
...
5. ### ***设置网络连接类型***
   ...
   ![输入图片说明](image/image1-5.png)

---

6. ### ***设置磁盘大小：100G； 并将虚拟磁盘存储为单个文件； 完成创建虚拟机配置***

   ![输入图片说明](image/image1-6.png)
   ![输入图片说明](image/image1-7.png)
  
---

7. ### ***安装设置 中文 语言***

   ![输入图片说明](image/image1-8.png)

---

8. ### ***设置安装地址，以及网络连接***

   ![输入图片说明](image/image1-9.png)

   ![输入图片说明](image/image1-10.png)

   ![输入图片说明](image/image1-11.png)

---

9. ### ***开始安装***

   ![输入图片说明](image/image1-12.png)

---

10. ### ***设置root密码(必须设置)； 以及自定用户名的信息(可不设置)***

    ![输入图片说明](image/image1-13.png)
...
1. ### ***连接虚拟机***
   ...
   ![输入图片说明](image/image1-18.png)
   
---

2. ### ***连接成功***

   ![输入图片说明](image/image1-19.png)
