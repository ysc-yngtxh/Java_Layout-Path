...
-- ----------------------------
BEGIN;
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('diagnostics.allow_i_s_tables', 'OFF', '2023-04-24 12:14:01', NULL);
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('diagnostics.include_raw', 'OFF', '2023-04-24 12:14:01', NULL);
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('ps_thread_trx_info.max_length', '65535', '2023-04-24 12:14:01', NULL);
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('statement_performance_analyzer.limit', '100', '2023-04-24 12:14:01', NULL);
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('statement_performance_analyzer.view', NULL, '2023-04-24 12:14:01', NULL);
INSERT INTO `sys_config` (`variable`, `value`, `set_time`, `set_by`) VALUES ('statement_truncate_len', '64', '2023-04-24 12:14:01', NULL);
COMMIT;
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='菜单表';

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (1, '部门管理', 'dept', 'system/dept/inidex', '0', '0', 'system:dept:list', '#', 322, '2022-08-05 00:06:02', 322, '2022-08-05 00:06:17', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (2, '测试', 'test', 'system/test/inidex', '0', '0', 'system:test:list', '#', 322, '2022-08-05 00:06:02', 322, '2022-08-05 00:06:17', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (3, '视图1-1', '/level1/1', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (4, '视图1-2', '/level1/2', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (5, '视图1-3', '/level1/3', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (6, '视图2-1', '/level2/1', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (7, '视图2-2', '/level2/2', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (8, '视图2-3', '/level2/3', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (9, '视图3-1', '/level3/1', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (10, '视图3-2', '/level3/2', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (11, '视图3-3', '/level3/3', NULL, '0', '0', NULL, '#', NULL, '2023-05-14 09:57:34', NULL, '2023-05-14 09:57:52', 0, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (12, '查询用户信息', '/find/user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_menu` (`id`, `menu_name`, `path`, `component`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`, `remark`) VALUES (14, '错误路径', '/error', NULL, '0', '0', NULL, '#', NULL, NULL, NULL, NULL, 0, NULL);
COMMIT;
...
CREATE TABLE `sys_role` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL DEFAULT 'NULL' COMMENT '角色名称',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` (`id`, `name`, `role_key`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (1, 'ROLE_CEO', 'zPdLfn8Ed2', '7', 0, 322, '2015-09-27 17:25:12', 322, '2000-01-07 09:17:43', 'OuiVlBKmkf');
INSERT INTO `sys_role` (`id`, `name`, `role_key`, `status`, `del_flag`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2, 'ROLE_CODER', 'E8oTSFrvqh', '7', 0, 322, '2015-11-17 17:36:32', 322, '2007-04-27 12:28:47', 'Mcl88fJS2M');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色菜单关系表';
...
CREATE TABLE `sys_user` (
  ...
  `permssion` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '用户权限',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` (`id`, `user_name`, `nick_name`, `password`, `status`, `email`, `phonenumber`, `sex`, `avatar`, `user_type`, `permssion`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (1, 'Cao yumin', '这里使用的默认的盐值加密算法 BCryptPasswordEncoder', '$2a$10$Y9DWuEwLeJY0aJOZLI1vBO2O0iOCOxGug1mXj1AKsAl3WHyaKGsUu', '4', 'moreno716@yahoo.com', '760-995-7970', 'F', 'N8X9CqRT5u', '0', '[\"admin\",\"test\",\"system:admin:list\",\"system:test:abc\",\"ROLE_vip1\",\"ROLE_vip2\",\"ROLE_vip3\"]', 180, '2009-09-21 05:31:17', 92, '2017-06-19 16:20:43', 0);
INSERT INTO `sys_user` (`id`, `user_name`, `nick_name`, `password`, `status`, `email`, `phonenumber`, `sex`, `avatar`, `user_type`, `permssion`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (2, 'You shicheng', '这里使用的是SpringSecurity默认的算法 NoopPasswordEncoder', '{noop}123456', 'M', 'zhennan706@outlook.com', '70-4164-6976', 'M', 'QOiW5NkwPF', 'M', '[\"admin\"]', NULL, NULL, NULL, '2002-03-18 07:24:39', 0);
INSERT INTO `sys_user` (`id`, `user_name`, `nick_name`, `password`, `status`, `email`, `phonenumber`, `sex`, `avatar`, `user_type`, `permssion`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (6, 'Chen pingan', '这里使用的是自定义的盐值加密算法 BCryptPasswordEncoder', '$2$10$shichengqwertyuioplkjeSl3MuR8NfOYAsV/JD67tbSPGk43OE.C', 'M', 'zhennan706@outlook.com', '70-4164-6976', 'M', 'QOiW5NkwPF', 'M', '[\"test\",\"ROLE_vip1\",\"ROLE_vip2\",\"ROLE_vip3\"]', NULL, NULL, NULL, '2002-03-18 07:24:39', 0);
INSERT INTO `sys_user` (`id`, `user_name`, `nick_name`, `password`, `status`, `email`, `phonenumber`, `sex`, `avatar`, `user_type`, `permssion`, `create_by`, `create_time`, `update_by`, `update_time`, `del_flag`) VALUES (7, 'Ye shiqi', '这里使用的是自定义的盐值加密算法 BCryptPasswordEncoder', '$2$10$shichengqwertyuioplkjeSl3MuR8NfOYAsV/JD67tbSPGk43OE.C', 'M', 'zhennan706@outlook.com', '70-4164-6976', 'M', 'QOiW5NkwPF', 'M', '[\"test\",\"ROLE_vip1\",\"ROLE_vip2\",\"ROLE_vip3\"]', NULL, '2023-05-14 10:10:59', NULL, '2023-05-14 10:10:39', 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户角色关系表';
