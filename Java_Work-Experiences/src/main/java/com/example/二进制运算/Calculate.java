...
public class Calculate {
    ...
    */
    public static void main(String[] args) {
        ...
        int a4 = 6;    // 6 = 0000 1100
        log.debug("<<（左移）计算结果：{}", (a4 << 2)); // 结果是 24，因为6左移2位得到的是0001 1000，对应的十进制是24。
        log.debug(">>（右移）计算结果：{}", (a4 >> 2)); // 结果是 1， 因为6右移2位得到的是0000 0001，对应的十进制是1。
